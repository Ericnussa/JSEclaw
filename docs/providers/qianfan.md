---
summary: "Use Qianfan's unified API to access many models in JSEBot"
read_when:
...
3. JSEBot installed on your system
...
4. Copy the API key for use with JSEBot
...
- [JSEBot Configuration](/gateway/configuration)

...
You can point JSEBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or JSEBot
...
- [Anthropic provider](/providers/anthropic) - Native JSEBot integration with Claude setup-token or API keys

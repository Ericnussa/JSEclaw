---
summary: "Use Qwen OAuth (free tier) in JSEBot"
read_when:
  - You want to use Qwen with JSEBot
...
If you already logged in with the Qwen Code CLI, JSEBot will sync credentials

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with JSEBot"
read_when:
  - You want Xiaomi MiMo models in JSEBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). JSEBot uses

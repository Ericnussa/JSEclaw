---
summary: "Use Mistral models and Voxtral transcription with JSEBot"
read_when:
  - You want to use Mistral models in JSEBot
...
JSEBot supports Mistral for both text/image model routing (`mistral/...`) and

...
read_when:
  ...
  - Wiring external systems into JSEBot
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your JSEBot config directory (typically `~/.openclaw/hooks/transforms`).

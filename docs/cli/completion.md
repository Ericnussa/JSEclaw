...
read_when:
  ...
  - You need to cache completion scripts under JSEBot state
title: "completion"
---
...
- `--install` writes a small "JSEBot Completion" block into your shell profile and points it at the cached script.

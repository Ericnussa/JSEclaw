...
read_when:
  ...
  - Deciding: standalone CLI vs deep JSEBot integration
...
Recommendation: **deep integration in JSEBot**, but keep a separable core library.

### Why integrate into JSEBot?

- JSEBot already knows:

...
This is a living document maintained by the JSEBot community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the JSEBot AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| JSEBot Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed JSEBot gateway endpoints                |
...
| ATLAS ID      | Technique Name                 | JSEBot Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | JSEBot's skill marketplace                              |
| **Gateway**          | JSEBot's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for JSEBot agents                |

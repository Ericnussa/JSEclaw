# Contributing to the JSEBot Threat Model

Thanks for helping make JSEBot more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of JSEBot are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [JSEBot Threat Model](./THREAT-MODEL-ATLAS.md)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the JSEBot security hall of fame for significant contributions.

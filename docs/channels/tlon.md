...
Tlon is a decentralized messenger built on Urbit. JSEBot connects to your Urbit ship and can
...
By default, JSEBot blocks private/internal hostnames and IP ranges for this plugin (SSRF hardening).
...
- Thread replies: if the inbound message is in a thread, JSEBot replies in-thread.

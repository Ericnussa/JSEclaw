...
JSEBot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

JSEBot “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, JSEBot can see that group and respond there.
...
Translation: allowlisted senders can trigger JSEBot by mentioning it.

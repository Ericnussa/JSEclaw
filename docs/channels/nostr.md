...
read_when:
  - You want JSEBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables JSEBot to receive and respond to encrypted direct messages (DMs) via NIP-04.

---
summary: "Synology Chat webhook setup and JSEBot config"
read_when:
  - Setting up Synology Chat with JSEBot
...
3. Point the outgoing webhook URL to your JSEBot gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in JSEBot.
...
```bash
openclaw message send --channel synology-chat --target 123456 --text "Hello from JSEBot"

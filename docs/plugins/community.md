...
read_when:
  - You want to publish a third-party JSEBot plugin
...
This page tracks high-quality **community-maintained plugins** for JSEBot.
...
- **WeChat** — Connect JSEBot to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.

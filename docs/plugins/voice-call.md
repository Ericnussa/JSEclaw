...
read_when:
  - You want to place an outbound voice call from JSEBot
...
Voice calls for JSEBot via a plugin. Supports outbound notifications and
...
```bash
openclaw voicecall call --to "+15555550123" --message "Hello from JSEBot"

...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 JSEBot 安装
title: Ansible
x-i18n:
...
将 JSEBot 部署到生产服务器的推荐方式是通过 **[openclaw-ansible](https://github.com/openclaw/openclaw-ansible)** — 一个安全优先架构的自动化安装程序。
...
Ansible 安装程序设置 JSEBot 为手动更新。标准更新流程参见[更新](/install/updating)。

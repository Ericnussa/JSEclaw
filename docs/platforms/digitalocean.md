---
summary: "JSEBot on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up JSEBot on DigitalOcean
  - Looking for cheap VPS hosting for JSEBot
title: "DigitalOcean"
---

# JSEBot on DigitalOcean

## Goal

Run a persistent JSEBot Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
```bash
jsebot channels login whatsapp
# Scan QR code
```

...
- Same path: run the app from a fixed location (for JSEBot, `dist/JSEBot.app`).
...
Workaround: move files into the JSEBot workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.

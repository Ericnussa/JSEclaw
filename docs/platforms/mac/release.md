---
summary: "JSEBot macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a JSEBot macOS release
  - Updating the Sparkle appcast or feed assets
title: "macOS Release"
---

# JSEBot macOS release (Sparkle)
...
ditto -c -k --sequesterRsrc --keepParent dist/JSEBot.app dist/JSEBot-2026.3.2.zip

# Optional: also build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/JSEBot.app dist/JSEBot-2026.3.2.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/JSEBot.app.dSYM dist/JSEBot-2026.3.2.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/JSEBot-2026.3.2.zip https://raw.githubusercontent.com/openclaw/openclaw/main/appcast.xml
```
...
- Upload `JSEBot-2026.3.2.zip` (and `JSEBot-2026.3.2.dSYM.zip`) to the GitHub release for tag `v2026.3.2`.

---
summary: "JSEBot macOS companion app (menu bar + gateway broker)"
read_when:
...
# JSEBot macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for JSEBot. It owns permissions,
...
1. Install and launch **JSEBot.app**.
...
Avoid putting your JSEBot state dir in iCloud or other cloud-synced folders.

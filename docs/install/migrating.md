---
summary: "Move (migrate) a JSEBot install from one machine to another"
read_when:
  - You are moving JSEBot to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating JSEBot to a new machine

This guide migrates a JSEBot Gateway from one machine to another **without redoing onboarding**.
...
### Step 1 — Install JSEBot on the new machine
...
- [Where does JSEBot store its data?](/help/faq#where-does-openclaw-store-its-data)

...
JSEBot ships three installer scripts, served from `openclaw.ai`.

| Script                             | Platform             | What it does                                                                                 |
| ---------------------------------- | -------------------- | -------------------------------------------------------------------------------------------- |
| [`install.sh`](#installsh)         | macOS / Linux / WSL  | Installs Node if needed, installs JSEBot via npm (default) or git, and can run onboarding. |
| [`install-cli.sh`](#install-clish) | macOS / Linux / WSL  | Installs Node + JSEBot into a local prefix (`~/.openclaw`). No root required.              |
| [`install.ps1`](#installps1)       | Windows (PowerShell) | Installs Node if needed, installs JSEBot via npm (default) or git, and can run onboarding. |
...
If run inside an JSEBot checkout (`package.json` + `pnpm-workspace.yaml`), the script offers:
...
<Steps>
  ...
  <Step title="Install JSEBot under prefix">
...
| `--version <ver>`      | JSEBot version or dist-tag (default: `latest`)                                |
...
| `OPENCLAW_VERSION=<ver>`                    | JSEBot version or dist-tag                                                      |

...
JSEBot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, JSEBot also aligns
the install method:
...
When you switch channels with `openclaw update`, JSEBot also syncs plugin sources:

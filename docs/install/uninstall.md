---
summary: "Uninstall JSEBot completely (CLI, service, state, workspace)"
read_when:
  - You want to remove JSEBot from a machine
...
Default task name is `JSEBot Gateway` (or `JSEBot Gateway (<profile>)`).
The task script lives under your state dir.

```powershell
schtasks /Delete /F /TN "JSEBot Gateway"

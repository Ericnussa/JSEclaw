---
summary: "Overview of JSEBot onboarding options and flows"
read_when:
...
JSEBot supports multiple onboarding paths depending on where the Gateway runs
...
Use the JSEBot app when you want a fully guided setup on macOS. Docs:

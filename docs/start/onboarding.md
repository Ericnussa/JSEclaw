---
summary: "First-run onboarding flow for JSEBot (macOS app)"
read_when:
...
- By default, JSEBot is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give JSEBot">

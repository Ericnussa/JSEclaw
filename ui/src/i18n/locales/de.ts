...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.jsebot/jsebot.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von jsebot dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
